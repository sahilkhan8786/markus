export const DataLola = [
    { id: 1, title: 'Warum musst du so husten?', content: 'Content for section 1' },
    { id: 2, title: 'Lass uns das Gelernte einmal zusammenfassen!', content: 'Content for section 2' },
];

export const DataTom = [
    {
        id: 1, title: "Warum benötigen Lebewesen Luft?",
        content: "Weißt du, warum wir alle Luft zum Atmen brauchen? Denkt an eine Kerze. Damit sie brennen kann, braucht sie Luft. Ohne Luft geht die Flamme aus. So ähnlich ist es bei uns Menschen: ohne Sauerstoff könnten wir nicht spielen, lachen oder Fahrrad fahren, genauso wie die Kerze ohne Luft nicht brennen kann!"
    },
    {
        id: 2, title: "Wo sind wir hier?",
        content: "Hier im Park können wir so richtig tief durchatmen und die frische und saubere Luft genießen. Das liegt daran, dass die vielen Bäume und Pflanzen hier für gute Luft sorgen. Sie produzieren Sauerstoff, den wir zum Atmen brauchen, und filtern gleichzeitig schädliche Stoffe aus der Luft. Das ist wichtig für unsere Gesundheit. Denn nur wenn wir saubere Luft zum Atmen haben, bleiben wir gesund."
    },
    {
        id: 3, title: "Was kann ich hier erkunden?",
        content: "Klicke auf das Bild, halte die Maus gedrückt und ziehe sie in die Richtung, in die du blicken möchtest. So schaust du dich in Ruhe um. Entdecke so viel wie du möchtest und finde die versteckten Infos, indem du draufklickst. Hast du alles gefunden? Der Fortschrittsbalken unten rechts zeigt dir wieviel du entdeckt hast."
    },
]
...
export const FirstPageDetais = [
    ...
    },
    {
        ...
        detailsAfterVideo: "Sie verschmutzen die Luft: Die giftigen Stoffe in den Abgasen können unsere Lunge und unsere Gesundheit schädigen.,Sie machen krank: Menschen, die in der Nähe von stark befahrenen Straßen wohnen, leiden öfter an Atemproblemen und anderen Krankheiten.,Sie schädigen die Pflanzen und Tiere: Die giftigen Stoffe in den Abgasen können Pflanzen und Tiere vergiften und sogar töten.,Sie verändern das Klima: Autoabgase tragen zum Klimawandel bei, der die Erde erwärmt und extreme Wetterereignisse wie Hitzewellen und Stürme verursacht."

    },
    {
        id: "html-marker-sky",
        heading: 'Luft zum Atmen',
        videoURL: '9Hbg-8k7t-U',
    ...
    },
    {
        ...
        detailsAfterVideo: "Außerdem ist die Luft farblos und transparent.,Das bedeutet, dass sie kein Licht reflektiert und daher für unsere Augen unsichtbar ist.,Aber wir können die Luft trotzdem spüren,,            wenn wir den Wind auf unserer Haut fühlen oder wenn wir tief einatmen.,Luft ist also wie ein unsichtbarer Umhang, der die ganze Erde umgibt.,Sie ist wichtig für uns und alle anderen Lebewesen, denn sie enthält Sauerstoff, den wir zum Atmen brauchen."

    },
    {
        id: "CYCLE",
        videoURL: 'fqID1Nc228U',
        detailsAfterVideo: "Während wir hier so gemütlich durch den Park radeln, fällt euch bestimmt die frische Luft auf, oder? Das ist kein Zufall! Wisst ihr, Autos brauchen Benzin zum Fahren und Stoßen dabei Abgase aus, die unsere Luft verschmutzen. Das ist schlecht für uns und die Natur. Fahrräder sind da ganz anders! Wir brauchen nur unsere eigene Energie und pusten keine schädlichen Abgase in die Luft. Wenn wir also öfter Fahrrad fahren, schützen wir die Luft und halten sie sauber. Und ganz nebenbei macht Fahrradfahren auch noch richtig viel Spaß, findet ihr nicht?"
    }

]

import tomVideo from '/Tom Waving550x500.mp4'
import lolaVideo from '/Lola Waving.mp4'
export const baseMarkersPark = [
    {
...
export const additionalMarkersPark = [
